...
define -3 text_outline_color = "#3ca7c3"
...
init -1 style poemgame_text:
    ...
    hover_xoffset -3
    hover_outlines [(3, "#000", 0, 0), (2, "#000", 0, 0), (1, "#000", 0, 0)]
...
init -501 screen navigation():
    ...
    vbox:
        ...
        if not persistent.menu_bg_m and not main_menu:
...
init -1 style navigation_button_text:
    ...
    hover_outlines [(4, "#3ca7c3", 0, 0), (2, "#3ca7c3", 2, 2)]
    insensitive_outlines [(4, "#14c5eb", 0, 0), (2, "#14c5eb", 2, 2)]
...
init -501 screen main_menu():
    ...
    if not persistent.ghost_menu:
        ...
        #add "menu_particles"
        add "menu_logo"
        text "{font=mod_assets/minecraftia.ttf}{size=18}Doki Doki Renpy + STABLE":
            xoffset -780
            yoffset 690
        text "{font=mod_assets/minecraftia.ttf}{size=22}Now with axel's pussy!" at splashtext:
            color "#edff68"
            size 14
            xoffset -200
            yoffset 20
    ...
    vbox:
        ...
        if persistent.finished == False:
            imagebutton:
                ...
                idle "mod_assets/mb1.png"
                hover "mod_assets/mb2.png"
                action OpenURL("https://www.youtube.com/watch?v=0ullGSyYv1k")
                activate_sound gui.activate_sound
    ...
    hbox:
        ...
        imagebutton:
            xoffset -3
            idle "mod_assets/mb3.png"
            hover "mod_assets/mb4.png"
    ...
    vbox:
        ...
        xoffset 0
        yoffset -200
        text "{font=mod_assets/minecraftia.ttf}{size=22}New Game"
        text "{font=mod_assets/minecraftia.ttf}{size=22}Load Game":
            yoffset 8
            xoffset 10
        if persistent.finished == False:
            text "{font=mod_assets/minecraftia.ttf}{size=22}Pink Pussy":
                yoffset 16
                xoffset 10
        else:
    ...
    hbox:
        ...
        xalign 0.5
        yoffset 100
        text "{font=mod_assets/minecraftia.ttf}{size=22}Options":
            xoffset -50
            yoffset 5
        text "{font=mod_assets/minecraftia.ttf}{size=22}Quit Game":
            xoffset 35
            yoffset 5
    if gui.show_name:
...
init -1 style pref_label_text:
    ...
    size 24
    color "#fff"
    outlines [(3, "#3ca7c3", 0, 0), (1, "#3ca7c3", 1, 1)]
    yalign 1.0
