# Edited options.rpy from main DDLC with help from the monika after story mod template because im lazy
# _() marks strings eligable for translation

init python:
    config.gl2 = True

define config.name = "DDLC Renpy +"
...
define build.name = "DDLC_Renpy_Plus"
